...
from utils import train, evaluate, predict_disease, train_agcnn, evaluate_agcnn, predict_disease_agcnn, train_agcnn_multi
from plots import plot_learning_curves, plot_confusion_matrix
from mymodels import MyDenseNet, MyAGCNN, MyAGCNN_CRAL, MyDenseNetMultiClass, get_local_activated_patch, AGCNN_Fusion, AGCNN_Fusion_Cral
...
global_model = MyAGCNN_CRAL()
local_model = MyAGCNN_CRAL()
fusion_model = AGCNN_Fusion_Cral()
...
for epoch in range(NUM_EPOCHS):
	...
	train_loss, train_accuracy, train_global_loss, train_local_loss, train_fusion_loss = train_agcnn_multi(global_model, local_model, fusion_model, device, train_loader, criterion, optimizer_global, optimizer_local, optimizer_fusion, epoch)
